...
void MeanTimeDiff(char *file1, char*file2)
{
  ...
  TH1D* timing1 = (TH1D*)f1->Get("single-bias/timeVsAoSigmaEElog_1");
  TH1D* timing2 = (TH1D*)f2->Get("single-bias/timeVsAoSigmaEElog_1");
